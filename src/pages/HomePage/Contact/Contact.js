...
const Contact = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!name || !email || !message ) {
            toast.error("Vui lòng điền đầy đủ thông tin và chọn sự kiện");
            return;
        }
    ...
    return (
        <div>
            ...
            <div className="container7 d-flex justify-content-center align-items-center">
                <svg className='svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none">
                    <g id="Image">
                        <g id="g14">
                            <g id="g16">
                                <g id="g22">
                ...
                <form className='form' onSubmit={handleSubmit}>
                    <h1 className="title9 text-center mb-4">Liên hệ</h1>
                    ...
                    <div className="form-group message mt-4">
                    ...
                    <div className="text-center mt-4">
                        <button type="submit" className="btn btn-primary1" tabIndex="-1">
                            Gửi
                        </button>
                    </div>
                </form>
