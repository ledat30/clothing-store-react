                    ...
                    return (
                      <div key={index}>
                        <li
                          ...
                          key={item.id}
                        >
                          <div className="category-item__link">{item.name}</div>
                        </li>
                      </div>
                    );
                  })}
            ...
            <div className="home-filter hideOnMobile-tablet">
              ...
              <button
                className={`home-filter_btn btn-container ${
                  activeFilter === "allProducts" ? "btn--primary" : ""
                }`}
              ...
              <button
                className={`home-filter_btn btn-container ${
                  activeFilter === "bestSelling" ? "btn--primary" : ""
                }`}
                  ...
                  <div className="row sm-gutter">
                    {allProducts && allProducts.length > 0 ? (
                      allProducts.map((item, index) => {
                        const formattedPri = (item.price * 1000).toLocaleString(
                          "vi-VN",
                          {
                            style: "currency",
                            currency: "VND",
                        ...
                        return (
                          <div
                            className="col l-2-4 m-4 c-6 product-mr"
                            key={index}
                          >
                            <Link
                              to={`/product/${item.id}`}
